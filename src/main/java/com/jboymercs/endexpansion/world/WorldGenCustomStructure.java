package com.jboymercs.endexpansion.world;
...
import com.jboymercs.endexpansion.world.Biome.generation.WorldGenEndPlant;
...
import com.jboymercs.endexpansion.world.api.trader.WorldGenTraderOutcamp;
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        if(world.provider.getDimension() == 1  && Math.abs(pos.getX()) > 600 || world.provider.getDimension() == 1 && Math.abs(pos.getZ()) > 600 ) {
            if (WorldConfig.does_structure_spawn) {
                ...
                if(WorldConfig.lamented_islands_enabled) {
