package com.jboymercs.endexpansion.world.Biome.ore;
...
public abstract class WorldGenEndOre extends WorldGenerator {

    private final int num;

    public WorldGenEndOre(int num) {
        this.num = num;
    }
                ...
                if (d12 * d12 < 1.0D) for (int i2 = k; i2 <= j1; ++i2) {
                    ...
                    if (d12 * d12 + d13 * d13 < 1.0D) for (int j2 = l; j2 <= k1; ++j2) {
                        ...
                        if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D) {
                            ...
                            if (world.getBlockState(pos1).getBlock() != Blocks.END_STONE) continue;
