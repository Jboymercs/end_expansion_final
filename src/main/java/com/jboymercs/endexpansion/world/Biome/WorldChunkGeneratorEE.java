...
import com.jboymercs.endexpansion.world.Biome.decorator.WorldGenLongVein;
...
public class WorldChunkGeneratorEE extends ChunkGeneratorEnd {
    ...
    public void setBlocksInChunk(int x, int z, ChunkPrimer primer)
    {
        ...
        int k = 33;
        int l = 3;
        this.buffer = this.getHeightsEE(this.buffer, x * 2, 0, z * 2, 3, 33, 3);
    ...
    private float getIslandHeightValues(int p_185960_1_, int p_185960_2_, int p_185960_3_, int p_185960_4_)
    {
    ...
    {
        return (long)p_185961_1_ * (long)p_185961_1_ + (long)p_185961_2_ * (long)p_185961_2_ > 4096L && this.getIslandHeightValues(p_185961_1_, p_185961_2_, 1, 1) >= 0.0F;
    }

    private double[] getHeightsEE(double[] p_185963_1_, int p_185963_2_, int p_185963_3_, int p_185963_4_, int p_185963_5_, int p_185963_6_, int p_185963_7_)
    {
        ...
        for (int l = 0; l < p_185963_5_; ++l)
        {
            ...
            {
                float f = this.getIslandHeightValues(i, j, l, i1);
    ...
    public void populate(int x, int z)
    {
        ...
        if (i > 4096L)
        {
            float f = this.getIslandHeightValues(x, z, 1, 1);
            ...
            if (this.getIslandHeightValues(x, z, 1, 1) > 40.0F)
            {
