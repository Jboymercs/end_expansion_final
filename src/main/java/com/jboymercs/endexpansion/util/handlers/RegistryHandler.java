...
import com.jboymercs.endexpansion.blocks.arenaBlocks.ArenaStateMapper;
import com.jboymercs.endexpansion.init.ModBlocks;
import com.jboymercs.endexpansion.init.ModItems;
import com.jboymercs.endexpansion.items.ItemAbstractMultiModel;
import com.jboymercs.endexpansion.items.tools.CustomModelLoader;
import com.jboymercs.endexpansion.renderer.*;
import com.jboymercs.endexpansion.util.IHasModel;
import com.jboymercs.endexpansion.util.ModReference;
import com.jboymercs.endexpansion.util.data.AdvancedStateMap;
...
public class RegistryHandler {
    ...
    public static <T extends Item> T registerItem(T item, ResourceLocation name) {
        itemRegistry.register(item.setRegistryName(name).setTranslationKey(name.getNamespace() + "." + name.getPath()));
        return item;
    }
