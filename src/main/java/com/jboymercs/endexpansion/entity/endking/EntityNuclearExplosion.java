    ...
    public void onUpdate() {
        ...
        if(ticksExisted > 15 && ticksExisted < 85) {
            ...
            if(damageWorld) {
                ...
                List<EntityLivingBase> nearbyEntities = this.world.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().grow(10D), e -> (!(e instanceof EntityEndKing)));
                ...
                for(EntityLivingBase entityLivingBase : nearbyEntities) {
                    ...
                    if(this.getDistanceSq(entityLivingBase) <= 49D) {
