...
import com.jboymercs.endexpansion.entity.barrend.EntityBarrendGolem;
import com.jboymercs.endexpansion.entity.util.IAttack;
import net.minecraft.entity.EntityLivingBase;
import net.minecraft.entity.ai.EntityAIBase;

public class EntityAIBarrendGolem <T extends EntityBarrendGolem & IAttack> extends EntityAIBase {
    ...
    public EntityAIBarrendGolem(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityAIBarrendGolem(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
    ...
    public void updateTask() {
        ...
        if (target == null || this.entity.isCharge()) {
            return;
        }
