...
public class AIPassiveCircle<T extends EntityModBase> extends EntityAIBase {
    ...
    private Vec3d getCirclePoint(Vec3d center, Vec3d entityDirection, double rotationDegrees, int radiusOffset) {
        Vec3d projectedEntityDirection = ModUtils.planeProject(entityDirection, planeVectorPath).normalize().scale(circleRadius + radiusOffset);
