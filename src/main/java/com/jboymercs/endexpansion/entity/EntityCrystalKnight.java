...
import com.jboymercs.endexpansion.entity.ai.*;
import com.jboymercs.endexpansion.entity.lamentorUtil.ActionCircleAOE;
import com.jboymercs.endexpansion.entity.util.IAttack;
import com.jboymercs.endexpansion.entity.util.TimedAttackIniator;
...
public class EntityCrystalKnight extends EntityModBase implements IAnimatable, IAttack {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue((double)MobConfig.health * getHealthModifierLamented());
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(MobConfig.attack_damage * getAttackModifierLamented());
    }
