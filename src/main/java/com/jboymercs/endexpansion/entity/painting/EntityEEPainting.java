package com.jboymercs.endexpansion.entity.painting;
...
public class EntityEEPainting extends EntityHanging implements IEntityAdditionalSpawnData {


    public EntityEEPainting(World worldIn) {
        super(worldIn);
    }

    public EntityEEPainting(World worldIn, BlockPos hangingPositionIn, EnumFacing facing) {
    ...
    public void onBroken(@Nullable Entity brokenEntity) {
        ...
        this.entityDropItem(new ItemStack(ModItems.MOD_PAINTING.getDefaultInstance().getItem(), 1), 0.0F);
    }
