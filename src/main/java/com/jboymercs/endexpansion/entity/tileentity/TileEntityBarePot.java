...
public class TileEntityBarePot extends TileEntity implements ILootContainer, IInventory {
    ...
    public boolean isItemValidForSlot(int slot, ItemStack stack) {
        ...
        if (!ModUtils.compareItemStacks(stack, this.stack, true)) return false;
    ...
    public String getName() {
        return "container.endexpansion.smallPot";
    }
