...
public class ModelSnatcher extends GeoModelExtended<EntitySnatcher> {
    public ModelSnatcher(ResourceLocation model, ResourceLocation textureDefault, String entityName) {
