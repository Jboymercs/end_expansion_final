...
public class EntityShadowFollow extends EntityAIBase {
    private final EntityShadowPlayer tameable;
    ...
    public EntityShadowFollow(EntityShadowPlayer tameableIn, double followSpeedIn, float minDistIn, float maxDistIn)
    {
