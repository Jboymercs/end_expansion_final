...
import com.jboymercs.endexpansion.entity.model.ModelFriendKing;
...
public class RenderFriendKing extends RenderAbstractGeoEntity<EntityFriendKing>{
    ...
    @Override
    public void doRender(EntityFriendKing entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    @Override
    public boolean shouldRender(@Nonnull EntityFriendKing livingEntity, @Nonnull ICamera camera, double camX, double camY, double camZ) {
