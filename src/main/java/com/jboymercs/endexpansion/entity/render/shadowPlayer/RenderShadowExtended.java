...
public abstract class RenderShadowExtended<T extends EntityModBase & IAnimatable> extends GeoEntityRenderer<T> {
    ...
    protected RenderShadowExtended(RenderManager renderManager, AnimatedGeoModel<T> modelProvider) {
        this(renderManager, modelProvider, 1D, 1D, 0);
    }

    protected RenderShadowExtended(RenderManager renderManager, AnimatedGeoModel<T> modelProvider, double widthScale, double heightScale, float shadowSize) {
