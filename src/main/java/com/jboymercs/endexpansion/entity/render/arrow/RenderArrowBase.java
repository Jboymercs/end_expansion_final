package com.jboymercs.endexpansion.entity.render.arrow;
...
public class RenderArrowBase extends Render<EntityModArrow> {
    ...
    public void renderDart(EntityModArrow dart, double d, double d1, double d2, float f, float f1)
    {
        if (dart.isInvisible())
        {
            return;
    ...
    @Override
    public void doRender(EntityModArrow entity, double d, double d1, double d2, float f, float f1)
    {
