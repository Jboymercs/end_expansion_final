package com.jboymercs.endexpansion.entity.render.geo;

import com.jboymercs.endexpansion.entity.EntityModBaseTameable;
import com.jboymercs.endexpansion.util.misc.BlockRenderUtil;
import com.jboymercs.endexpansion.util.misc.MatrixUtil;
...
public abstract class RenderTamaebleGeoExtend <T extends EntityModBaseTameable & IAnimatable> extends GeoEntityRenderer<T> {
    ...
    protected RenderTamaebleGeoExtend(RenderManager renderManager, AnimatedGeoModel<T> modelProvider) {
        this(renderManager, modelProvider, 1D, 1D, 0);
    }

    protected RenderTamaebleGeoExtend(RenderManager renderManager, AnimatedGeoModel<T> modelProvider, double widthScale, double heightScale, float shadowSize) {
