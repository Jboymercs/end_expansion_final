...
import com.jboymercs.endexpansion.entity.tileentity.TileEntityAshChute;
...
public class BlockAshChute extends BlockBase {

    public static final PropertyDirection FACING = BlockDirectional.FACING;



    public BlockAshChute(String name, Material material, float hardness, float resistance, SoundType soundType) {
