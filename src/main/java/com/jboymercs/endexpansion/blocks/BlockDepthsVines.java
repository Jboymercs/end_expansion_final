...
import com.jboymercs.endexpansion.util.handlers.RegistryHandler;
...
public class BlockDepthsVines extends BlockBush implements IHasModel, RegistryHandler.IStateMappedBlock {
    ...
    public BlockDepthsVines(String name, Material materialIn) {
        super(materialIn);
    ...
    protected boolean isValidBlock(World world, BlockPos pos, IBlockState blockState) {
        return blockState.isSideSolid(world, pos, EnumFacing.DOWN) || blockState.getBlock() == this || blockState.getBlock() == ModBlocks.BROWN_END_STONE;
    }
    ...
    protected boolean canSustainBush(IBlockState state) {
        return state.getBlock() == ModBlocks.BROWN_END_STONE;
    }
