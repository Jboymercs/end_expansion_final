...
public class ItemGunLauncher extends ItemAbstractMultiModel implements IHasModel {
    ...
    public void registerModels() {
        ...
        ImmutableList<ModelResourceLocation> MList = ImmutableList.of(new ModelResourceLocation("endexpansion:gun", "inventory"),
                new ModelResourceLocation("endexpansion:gun_model", "inventory"));
        mrls.addAll(MList);
