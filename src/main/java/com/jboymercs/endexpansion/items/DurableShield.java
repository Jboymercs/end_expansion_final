...
public class DurableShield extends ItemShield implements IAnimatable {
    ...
    public String getItemStackDisplayName(ItemStack stack)
    {
        if (stack.getSubCompound("BlockEntityTag") != null)
        {
            ...
            return I18n.translateToLocal("item." + ModReference.MOD_ID + ".durable_shield." + enumdyecolor.getTranslationKey() + ".name");
        }
        else
        {
            return I18n.translateToLocal("endexpansion.desc.shield_name_desc");
        }
    }
