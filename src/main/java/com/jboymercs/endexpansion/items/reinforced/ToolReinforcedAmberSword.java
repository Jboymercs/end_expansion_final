package com.jboymercs.endexpansion.items.reinforced;
...
import com.jboymercs.endexpansion.items.tools.ToolSword;
...
public class ToolReinforcedAmberSword extends ToolSword {

    private String info_loc;

    public ToolReinforcedAmberSword(String name, ToolMaterial material, String info_loc) {
        super(name, material);
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer player, EnumHand hand)
    {
        ...
        if(!worldIn.isRemote && !player.getCooldownTracker().hasCooldown(this)) {
            ...
            int SwordCoolDown = (hasDamagedEntities) ? (howManyEntities + ItemConfig.cordium_sword_cooldown + 1) * 20 : ItemConfig.cordium_sword_cooldown * 20;
