...
public class ArmorLamented extends ItemArmor implements IHasModel {
    ...
    public ArmorLamented(String name, ItemArmor.ArmorMaterial materialIn, int renderIdx, EntityEquipmentSlot slotIn, String textureName, String info_loc) {
    ...
    public ArmorLamented setArmorBonusDesc(String armorBonusDesc) {
