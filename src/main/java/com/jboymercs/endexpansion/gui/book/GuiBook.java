package com.jboymercs.endexpansion.gui.book;

import com.jboymercs.endexpansion.config.ProgressionConfig;
...
public class GuiBook extends GuiScreen {
    ...
    private static final ResourceLocation MOB_PICTURES = new ResourceLocation( "endexpansion:textures/gui/cards.png");
    private static final ResourceLocation MOB_PICTURES_2 = new ResourceLocation("endexpansion:textures/gui/cards_2.png");
    private static final ResourceLocation BLOCK_PICTURES = new ResourceLocation("endexpansion:textures/gui/block_cards.png");
    private static final ResourceLocation BLOCK_PICTURES_2 = new ResourceLocation("endexpansion:textures/gui/block_cards_2.png");
    private static final ResourceLocation ENDFALL_PICTURES = new ResourceLocation("endexpansion:textures/gui/block_cards_3.png");

    private static final ResourceLocation BLOCK_PICTURES_4 = new ResourceLocation("endexpansion:textures/gui/block_cards_4.png");

    private static final ResourceLocation BLOCK_PICTURES_5 = new ResourceLocation("endexpansion:textures/gui/block_cards_5.png");
    private static final ResourceLocation BLOCK_PICTURES_6 = new ResourceLocation("endexpansion:textures/gui/blocks_cards_6.png");
        ...
        switch (pages) {
            ...
            case 2:
                ...
                if(ModUtils.getAdvancementCompletion(player, "kill_seeker")) {
                    ...
                    this.createRightPictureTitleFromString("entity.endexpansion.end_seeker.name");
            ...
            case 3:
                ...
                if (ModUtils.getAdvancementCompletion(player, "kill_guilder")) {
                    ...
                    this.createRightPictureTitleFromString("entity.endexpansion.controller.name");
            ...
            case 5:
                ...
                if(ModUtils.getAdvancementCompletion(player, "kill_constructor")) {
                    this.mc.renderEngine.bindTexture(MOB_PICTURES);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13,0, 0, 115, 58, 115, 464);
                    this.createRightPictureTitleFromString("entity.endexpansion.buffker.name");
          ...
          GlStateManager.popMatrix();
            ...
            case 6:
                ...
                if(ModUtils.getAdvancementCompletion(player, "kill_seeker_prime") || ModUtils.getAdvancementCompletion(player, "kill_lamentor")) {
                    ...
                    this.createLeftPictureTitleFromString("entity.endexpansion.crystal_boss.name");
            ...
            case 8:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.lamentor_progress_stages)) {
                    this.mc.renderEngine.bindTexture(BLOCK_PICTURES);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13,0, 0, 115, 58, 115, 464);
                    this.createRightPictureTitleFromString("tile.endexpansion.ash_brick.name");
            ...
            case 9:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.lamentor_progress_stages)) {
                    ...
                    this.mc.renderEngine.bindTexture(BLOCK_PICTURES_2);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13, 0, 0, 115, 58, 115, 464);
                    this.createLeftPictureTitleFromString("item.endexpansion.red_crystal_item.name");
            ...
            case 10:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.lamentor_progress_stages)) {
                    ...
                    this.createLeftPictureTitleFromString("tile.endexpansion.ash_door.name");
                    this.writeLeftFromString(6, 13, "desc.hole_");
                    this.createRightPictureTitleFromString("tile.endexpansion.end_door.name");
            ...
            case 11:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.lamentor_progress_stages)) {
                    ...
                    this.createLeftPictureTitleFromString("tile.endexpansion.ash_trap_floor.name");
                    this.writeLeftFromString(6, 12, "desc.trap_");
                    this.createRightPictureTitleFromString("tile.endexpansion.red_lamp.name");
            ...
            case 12:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.lamentor_progress_stages)) {
                    ...
                    this.mc.renderEngine.bindTexture(BLOCK_PICTURES_4);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13,0, 116, 115, 58, 115, 464);
                    this.createLeftPictureTitleFromString("item.endexpansion.brick_rod.name");
                    this.createRightPictureTitleFromString("tile.endexpansion.amber_ore.name");
            ...
            case 13:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.cordium_progress_stages)) {
                    ...
                    this.mc.renderEngine.bindTexture(BLOCK_PICTURES_5);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13,0, 174, 115, 58, 115, 464);
                    this.createLeftPictureTitleFromString("tile.endexpansion.amber_torch.name");
                    this.createRightPictureTitleFromString("item.endexpansion.amber_pickaxe.name");
            ...
            case 14:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.cordium_progress_stages)) {
                    ...
                    drawModalRectWithCustomSizedTexture((this.width - 245) / 2, 13,0, 232, 115, 58, 115, 464);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13,0, 290, 115, 58, 115, 464);
                    this.createLeftPictureTitleFromString("item.endexpansion.amber_axe.name");
                    this.createRightPictureTitleFromString("item.endexpansion.amber_dagger.name");
            ...
            case 15:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.infused_crystal_progress_stage)) {
                    ...
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13, 0, 406, 115, 58, 115, 464);
                    this.createLeftPictureTitleFromString("item.endexpansion.infused_crystal.name");
                    this.createRightPictureTitleFromString("item.endexpansion.endfall_pickaxe.name");
            ...
            case 17:
                ...
                if(ModUtils.getAdvancementCompletion(player, "kill_chomper")) {
                    this.mc.renderEngine.bindTexture(BLOCK_PICTURES_4);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13, 0, 58, 115, 58, 115, 464);
                    this.createRightPictureTitleFromString("entity.endexpansion.depths_chomper.name");
            ...
            case 18:
                ...
                if(ModUtils.getAdvancementCompletion(player, "kill_end_bug")) {
                    this.mc.renderEngine.bindTexture(MOB_PICTURES);
                    drawModalRectWithCustomSizedTexture((this.width - 245) / 2, 13,0, 290, 115, 58, 115, 464);
                    this.createLeftPictureTitleFromString("entity.endexpansion.end_bug.name");
                ...
                if(ModUtils.getAdvancementCompletion(player, "kill_stalker")) {
                    this.mc.renderEngine.bindTexture(MOB_PICTURES);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13,0, 116, 115, 58, 115, 464);
                    this.createRightPictureTitleFromString("entity.endexpansion.snatcher.name");
            ...
            case 21:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.dark_armor_progress_stage)) {
                    ...
                    this.createLeftPictureTitleFromString("item.endexpansion.dark_helmet.name");
                    this.createRightPictureTitleFromString("item.endexpansion.dark_chestplate.name");
            ...
            case 22:
                ...
                if(ModUtils.getAdvancementCompletion(player, "kill_ultra_knight")) {
                    this.mc.renderEngine.bindTexture(MOB_PICTURES);
                    drawModalRectWithCustomSizedTexture((this.width - 245) / 2, 13,0, 232, 115, 58, 115, 464);
                    this.createLeftPictureTitleFromString("entity.endexpansion.end_lord.name");
                ...
                if(ModUtils.getAdvancementCompletion(player, "kill_king")) {
                    this.mc.renderEngine.bindTexture(MOB_PICTURES);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13, 0, 348, 115, 58, 115, 464);
                    this.createRightPictureTitleFromString("entity.endexpansion.end_king.name");
            ...
            case 25:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.end_fall_progress_stage)) {
                    this.mc.renderEngine.bindTexture(BLOCK_PICTURES_6);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13, 0, 290, 115, 58, 115, 464);
                    this.createRightPictureTitleFromString("item.endexpansion.memory_stone.name");
            ...
            case 26:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.lidoped_progress_stage)) {
                    ...
                    this.mc.renderEngine.bindTexture(BLOCK_PICTURES_6);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13, 0, 348, 115, 58, 115, 464);
                    this.createLeftPictureTitleFromString("entity.endexpansion.lidoped.name");
                    this.writeLeftFromString(6, 13, "desc.lidoped_");
                    this.createRightPictureTitleFromString("item.endexpansion.lidoped_helmet.name");
            ...
            case 27:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.lidoped_progress_stage) && ModUtils.getAdvancementCompletion(player, "craft_infused_crystal")) {
                    this.mc.renderEngine.bindTexture(BLOCK_PICTURES_6);
                    drawModalRectWithCustomSizedTexture((this.width - 245) / 2, 13, 0, 406, 115, 58, 115, 464);
                    this.createLeftPictureTitleFromString("item.endexpansion.blood_reinforce.name");
            ...
            case 30:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.end_fall_progress_stage)) {
                    ...
                    drawModalRectWithCustomSizedTexture((this.width - 245) / 2, 13, 0, 174, 115, 58, 115, 464);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13, 0, 232, 115, 58, 115, 464);
                    this.createLeftPictureTitleFromString("item.endexpansion.endfall_helmet.name");
                    this.createRightPictureTitleFromString("item.endexpansion.endfall_chestplate.name");
            ...
            case 31:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.end_fall_progress_stage)) {
                    ...
                    this.createRightPictureTitleFromString("tile.endexpansion.mini_nuke.name");
            ...
            case 32:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.end_fall_progress_stage)) {
                    ...
                    drawModalRectWithCustomSizedTexture((this.width - 245) / 2, 13, 0, 58, 115, 58, 115, 464);
                    drawModalRectWithCustomSizedTexture((this.width + 17) / 2, 13, 0, 116, 115, 58, 115, 464);
                    this.createLeftPictureTitleFromString("item.endexpansion.endfall_sword.name");
                    this.createRightPictureTitleFromString("item.endexpansion.bow.name");
            ...
            case 33:
                ...
                if(ModUtils.getAdvancementCompletionAsList(player, ProgressionConfig.end_fall_progress_stage)) {
                    this.mc.renderEngine.bindTexture(BLOCK_PICTURES);
                    drawModalRectWithCustomSizedTexture((this.width - 245) / 2, 13, 0, 58, 115, 58, 115, 464);
                    this.createLeftPictureTitleFromString("item.endexpansion.efstaff.name");
    ...
    private void writeLeftFromString(int lineStart, int lineEnd, String text) {
        for(int x = lineStart; x <= lineEnd; x++) {
            ...
            this.drawScaledCenteredBookString(s, i + 70, 70 + (x * 8), 0.6F, 0.6F, TextFormatting.BLACK);
        }
    }
    ...
    private void writeRightFromString(int lineStart, int lineEnd, String text) {
        for(int x = lineStart; x <= lineEnd; x++) {
            String s = I18n.format(text + x);
            int i = (this.width - X) / 2;
            this.drawScaledCenteredBookString(s, i + 200, 70 + (x * 8), 0.6F, 0.6F, TextFormatting.BLACK);
        }
    }
    ...
    private void createRightTitleFromString(String text) {
        ...
        int i = (this.width - X) / 2;
        this.drawScaledCenteredBookString(s, i + 200, 22, 0.8F, 0.75F, TextFormatting.GRAY);
    }

    private void createLockedEntryRight(String text) {
        String s = I18n.format(text);
        int i = (this.width - X) / 2;
        this.drawScaledCenteredBookString(s, i + 200, 33, 0.8F, 0.75F, TextFormatting.GRAY);
    }
    ...
    private void createLockedEntryLeft(String text) {
        String s = I18n.format(text);
        int i = (this.width - X) / 2;
        this.drawScaledCenteredBookString(s, i + 70, 33, 0.8F, 0.75F, TextFormatting.GRAY);
    }
    ...
    private void writeAdvRequirementsRight(String[] advancementList) {
        ...
        for(int x = 7; x <= 13; x++) {
            ...
            int i = (this.width - X) / 2;
            this.drawScaledCenteredBookString(s, i + 200, 70 + (6 * 8), 0.6F, 0.6F, TextFormatting.BLACK);
        }
    }
    ...
    private void createIndexTitleFromString(int x, int y, String text) {
        String s = I18n.format(text);
        int i = (this.width - X) / 2;
        this.drawScaledCenteredBookString(s, i + x, y, 0.8F, 0.75F, TextFormatting.GRAY);
    }
    ...
    private void createLeftTitleFromString(String text) {
        String s = I18n.format(text);
        int i = (this.width - X) / 2;
        this.drawScaledCenteredBookString(s, i + 70, 22, 0.8F, 0.75F, TextFormatting.GRAY);
    }

    private void createLeftPictureTitleFromString(String text) {
        String s = I18n.format(text);
        int i = (this.width - X) / 2;
        this.drawScaledCenteredBookString(s, i + 70, 77, 0.8F, 0.75F, TextFormatting.GRAY);
    }

    private void createRightPictureTitleFromString(String text) {
        String s = I18n.format(text);
        int i = (this.width - X) / 2;
        this.drawScaledCenteredBookString(s, i + 200, 77, 0.8F, 0.75F, TextFormatting.GRAY);
    }

    private void drawScaledCenteredBookString(String text, int centerX, int y, float scale, float widthScale, TextFormatting formatting) {
        String s = formatting + text;
        int k = this.fontRenderer.getStringWidth(text) / 2;
        GlStateManager.scale(scale, scale, 0.0F);
        GlStateManager.translate(scale == 0.6F ? 0.8F : 0.0F, scale == 0.6F ? 0.8F : 0.4F, 0F);
        this.fontRenderer.drawString(s, Math.round((centerX - (k * widthScale)) / scale),  Math.round(y / scale), 0);
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
    }
