...
import com.jboymercs.endexpansion.event_handler.DarkFogHandler;
...
public class BarrendFogRenderer extends IRenderHandler implements ISelectiveResourceReloadListener {
    private VertexBuffer vbo;
    private int displayList = -1;
    private static final VertexFormat FORMAT = DefaultVertexFormats.POSITION_TEX_COLOR;
    private int renderDistance = -1;
    private final Minecraft mc = Minecraft.getMinecraft();
    private final ResourceLocation texture = new ResourceLocation(ModReference.MOD_ID + ":textures/environment/barrend_fog.png");
