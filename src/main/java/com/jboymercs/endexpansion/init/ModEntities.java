...
import com.jboymercs.endexpansion.config.CompatConfig;
...
import com.jboymercs.endexpansion.entity.tileentity.*;
import com.jboymercs.endexpansion.entity.tileentity.source.TileEntityNoSource;
import com.jboymercs.endexpansion.entity.tileentity.source.TileEntityPowerSource;
...
import com.jboymercs.endexpansion.util.misc.EELogger;
...
public class ModEntities {
    ...
    private static void registerEntityWithID(String name, Class<? extends Entity> entity, int id, int range, Vec3i eggColor) {
        EntityRegistry.registerModEntity(new ResourceLocation(ModReference.MOD_ID + ":" + name), entity, ModReference.MOD_ID + "." + name, id, Main.instance, range, 1, true, eggColor.getX(), eggColor.getY());
    ...
    private static void registerEntity(String name, Class<? extends Entity> entity, int id, int range) {
        EntityRegistry.registerModEntity(new ResourceLocation(ModReference.MOD_ID + ":" + name), entity, ModReference.MOD_ID + "." + name, id, Main.instance, range, 1, true);
    }

    private static void registerFastProjectile(String name, Class<? extends Entity> entity, int id, int range) {
        EntityRegistry.registerModEntity(new ResourceLocation(ModReference.MOD_ID + ":" + name), entity, ModReference.MOD_ID + "." + name, id, Main.instance, range, 1, false);
    }
