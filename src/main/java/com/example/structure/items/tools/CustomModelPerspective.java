...
public class CustomModelPerspective implements IBakedModel {
    ...
    public CustomModelPerspective(String Itemname) {
        this.name = Itemname;
        GUIMRL = new ModelResourceLocation(new ResourceLocation(ModReference.MOD_ID, Itemname),"inventory");
        normalMRL = new ModelResourceLocation(new ResourceLocation(ModReference.MOD_ID,Itemname + "_model"),"inventory");
    }
