...
public class ToolBowModded extends ItemBow implements IHasModel {

    private String info_loc;

    public ToolBowModded(String name, String info_loc) {
        super();
            ...
            if (!itemstack.isEmpty() || flag)
            {
                ...
                if ((double)f >= 0.1D)
                {
                    ...
                    if (!worldIn.isRemote)
                    {
                        ...
                        if (j > 0)
                        {
                            entityarrow.setDamage(entityarrow.getDamage() + (double)j * 0.5D + 4.5D);
                        }
