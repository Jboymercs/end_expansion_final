...
public class EntityLidoped extends EntityBarrendMob implements IAttack, IAnimatable, IAnimationTickable {
    ...
    private void performAttachedAttack(EntityLivingBase target) {
        ...
        float damage = (float) (8 * ModConfig.biome_multiplier);
    ...
    public void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue((double) 20 * ModConfig.biome_multiplier);
        this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(10 * ModConfig.biome_multiplier);
