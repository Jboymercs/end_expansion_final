...
public class EntityAiTimedAttackLocked<T extends EntityModBase & IAttack> extends EntityAIBase {
    ...
    public EntityAiTimedAttackLocked(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityAiTimedAttackLocked(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
