...
public class EntityEnderKnight extends EntityKnightBase implements IAnimatable, IAttack, IAnimationTickable {
    ...
    private static final DataParameter<Boolean> STRIKE_ATTACK = EntityDataManager.createKey(EntityKnightBase.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> RUNNING_CHECK = EntityDataManager.createKey(EntityKnightBase.class, DataSerializers.BOOLEAN);
     private static final DataParameter<Boolean> DASH_ATTACK = EntityDataManager.createKey(EntityKnightBase.class, DataSerializers.BOOLEAN);

     private static final DataParameter<Boolean> SECOND_STRIKE = EntityDataManager.createKey(EntityKnightBase.class, DataSerializers.BOOLEAN);

     private static final DataParameter<Boolean> THIRD_STRIKE = EntityDataManager.createKey(EntityKnightBase.class, DataSerializers.BOOLEAN);
    ...
    addEvent(()-> this.lockLook = true, 3);
        addEvent(()-> {
            ...
            float damage = (float) (ModConfig.end_knight_damage * ModConfig.biome_multiplier);
    ...
    this.setSecondStrike(true);
        addEvent(()-> {
            ...
            float damage = (float) ((ModConfig.end_knight_damage + 2) * ModConfig.biome_multiplier);
            ModUtils.handleAreaImpact(1.0f, (e)-> damage, this, offset, source, 0.4f, 0, false);
        }, 10);
    ...
    private final Consumer<EntityLivingBase> regularStrike = (target) -> {
        ...
        addEvent(()-> {
            ...
            Vec3d offset = this.getPositionVector().add(ModUtils.getRelativeOffset(this, new Vec3d(1.0,1.3,0)));
            DamageSource source = ModDamageSource.builder().type(ModDamageSource.MOB).directEntity(this).build();
            float damage = (float) ((ModConfig.end_knight_damage + 1) * ModConfig.biome_multiplier);
            ModUtils.handleAreaImpact(1.0f, (e)-> damage, this, offset, source, 0.4f, 0, false);
        }, 12);
